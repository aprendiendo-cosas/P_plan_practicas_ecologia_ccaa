# Plan docente para las prácticas de ecología
...
![portada](https://raw.githubusercontent.com/aprendiendo-cosas/P_plan_practicas_ccaa/2026_2027/imagenes/portada.png)
...
En este caso, el objetivo que nos planteamos durante las prácticas es la creación de un libro digital sobre los distintos tipos de ecosistemas de Sierra Nevada. Cada estudiante se hará responsable de un tipo de ecosistema de Sierra Nevada. Como tenemos más estudiantes que tipos de ecosistemas, habrá ecosistemas repetidos. No pasa nada. Esto mejorará la colaboración entre estudiantes. En cada práctica aprenderemos las competencias y habilidades necesarias para darle contenido. La siguiente presentación muestra el procedimiento a seguir y los contenidos de las prácticas. Puedes descargar la presentación [aquí](https://github.com/aprendiendo-cosas/P_plan_practicas_ccaa/raw/2026_2027/presentacion/plan_practicas_2026_2027.pdf) en pdf, [aquí](https://github.com/aprendiendo-cosas/P_plan_practicas_ccaa/raw/2026_2027/presentacion/plan_practicas_2026_2027.zip) para Mac y [aquí](https://github.com/aprendiendo-cosas/P_plan_practicas_ccaa/raw/2026_2027/presentacion/plan_practicas_2026_2027.exe) para Windows. 
...
* **Dimensión composicional:** Comprende la identificación, catalogación y cuantificación de las entidades bióticas y abióticas que integran el sistema (los actores ecológicos). Esta dimensión se vincula estrechamente con disciplinas auxiliares como la botánica, la zoología o la edafología.


* **Dimensión estructural:** Describe la organización física, la arquitectura y la disposición espacial de los elementos composicionales. Es la dimensión que determina la fisonomía del sistema y permite diferenciar unidades ecológicas (por ejemplo, la estratificación arbórea de un bosque frente a la estructura horizontal de un pastizal o la matriz mineral de un arrecife de coral).


* **Dimensión funcional:** Concierne a las tasas biológicas, flujos de energía, intercambio de materia y procesos dinámicos (herbivoría, depredación, degradación de materia orgánica, ciclos biogeoquímicos). La estructura y la composición actúan como los sustantivos del sistema, mientras que la función representa los verbos y las dinámicas activas.



La interacción sinérgica entre la composición y la estructura genera una funcionalidad emergente específica. En sistemas antropizados o gestionados, esta funcionalidad da lugar a bienes y servicios ecosistémicos (aprovisionamiento, regulación hídrica, fijación de carbono y valores culturales).

```
                 COMPOSICIÓN
            (Especies, suelo, clima)
                      │
                      ▼
                 ESTRUCTURA
        (Disposición física y arquitectura)
                      │
                      ▼
                FUNCIONAMIENTO
       ...
       (Aprovisionamiento, regulación, soporte)
...
* **Entorno técnico:** Introducción al entorno de desarrollo RStudio y programación en lenguaje R para el procesamiento estadístico y gráfico de datos ecológicos.
...
* **Propiedades emergentes y teledetección espacial:** Monitorización espectral de la productividad primaria mediante índices de vegetación satelitales, examinando la heterogeneidad espacial y las oscilaciones fenológicas a lo largo del gradiente ambiental.


* **Valoración ecosistémica:** Identificación y balance de servicios de regulación, soporte y provisión derivados de la integridad ecológica del ecosistema.
